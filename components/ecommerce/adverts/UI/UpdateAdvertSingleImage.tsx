...
export const UpdateAdvertSingleImage: React.FC<UpdateAdvertSingleImageProps> = (
  props
) => {
  ...
  const advertImageSubmitHandler = (values: { file: Asset["file"] }) => {
    ...
    mutate({
      advertID: props.image.advertID,
      advertImageID: props.image.id,
      formData: formData,
    });
  };
