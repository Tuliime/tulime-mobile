...
type UpdateStoreLogoProps = {
  store: TEcommerceStore["store"];
};

export const UpdateStoreLogo: React.FC<UpdateStoreLogoProps> = (props) => {
  ...
  const hasLogo: boolean = !!props.store.logoUrl;
              ...
              <View style={styles.imagePickerContainer}>
                <View style={styles.imagePickerContent}>
                  <Text style={styles.imagePickerTitleSecondary}>
                    Select Logo image from Gallery
                  </Text>
                </View>
